            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            <span class="action-text">{{ actionType }}</span>
                        </button>
                        <button
                            type="button"
...
export default {
    ...
    props: ['titleText', 'bodyText', 'itemName', 'actionType'],
    methods: {
        response(value) {
    ...
    computed: {
        iconContainerStyle() {
            return this.actionType === 'delete' ? 'bg-red-100' : 'bg-blue-100'
        },
