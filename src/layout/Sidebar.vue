            ...
            >
                <perfect-scrollbar>
                    <ul class="navigation-left">
                        ...
                        <router-link
                            v-if="hasAuthorization(USER_MANAGEMENT)" to="/users" tag="li" class="nav-item"
                        >
                            <div class="nav-item-hold">
                                <i class="i-Male text-3xl"></i>
                                <p>Users</p>
                            </div>
                        </router-link>
                        <router-link
                            v-if="hasAuthorization(ROLE_MANAGEMENT)" to="/roles" tag="li" class="nav-item"
                        >
                            <div class="nav-item-hold">
                                <i class="i-Lock-User text-3xl"></i>
                                <p>Roles</p>
                            </div>
                        </router-link>
                        <router-link
                           v-if="hasAuthorization(COMPANY_MANAGEMENT)" to="/companies" tag="li" class="nav-item"
                        >
                            <div class="nav-item-hold">
                                <i class="i-University1 text-3xl"></i>
                                <p>Companies</p>
                            </div>
                        </router-link>
                        <a
...
export default {
    ...
    data () {
        return {
            currentRoles: this.$store.state.auth.role
        };
    },
    methods: {
